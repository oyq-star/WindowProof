"""Quick T-Drive experiment with smaller data for fast results."""
...
def main():
    ...
    trajs = load_preprocessed_csv("data/tdrive_sample.csv", max_trajectories=200, min_length=15, seed=seed)
    ...
    train_features = []
    max_windows_per_traj = 5  # Limit to keep data manageable
    ...
    # Save results
    os.makedirs("results_tdrive", exist_ok=True)
    results = {
        "dataset": "T-Drive (Beijing Taxi)",
    ...
    with open("results_tdrive/results.json", "w") as f:
        json.dump(results, f, indent=2, default=str)
    print("\nResults saved to results_tdrive/results.json")
